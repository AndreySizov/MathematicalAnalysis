...
class PracticeTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return mainDictionary["points"]!.count
    }


    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "practice", for: indexPath) as! PracticeTableViewCell

        let item: PointModel = mainDictionary["points"]![indexPath.row] as! PointModel
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        c = indexPath.row
        performSegue(withIdentifier: "showTaskVC", sender: tableView.cellForRow(at: indexPath))
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        while (i<mainDictionary["tasks"]!.count){
            ...
            let tm: PointModel = mainDictionary["points"]![c] as! PointModel
            if(d.pointId! as String == tm.id){
                tasks.add(d)
            }
            i+=1
